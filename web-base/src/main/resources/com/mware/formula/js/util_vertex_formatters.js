...
define([
    ...
    var V = {
           ...
           /**
            ...
            displayType: function(vertex) {
                ...
                if (_.some(propNames, function(propName) { return propName.indexOf('video-') === 0; })) {
                    return 'video';
                } else if (_.some(propNames, function(propName) { return propName.indexOf('audio-') === 0; })) {
                    return 'audio';
                } else {
    ...
    function transformMatchingVertexProperties(vertex, propertyNames, optionalKey) {
        var CONFIDENCE = ONTOLOGY_CONSTANTS.PROP_CONFIDENCE;
        var properties = [],
