...
const ONTOLOGY_CONSTANTS = {
    ...
    PROP_AUDIO_MP3: 'audio-mp3',
    PROP_AUDIO_MP4: 'audio-mp4',
    PROP_AUDIO_OGG: 'audio-ogg',
    PROP_VIDEO_MP4: 'video-mp4',
    PROP_VIDEO_WEBM: 'video-webm',
    ...
    PROP_IMAGE_TAG: 'imageTag',
    PROP_IMAGE_TAG_SCORE: 'imageTag',
