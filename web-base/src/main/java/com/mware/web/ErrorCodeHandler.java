...
public class ErrorCodeHandler implements RequestResponseExceptionHandler {
    ...
    @Override
    public void handle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, HandlerChain handlerChain, Throwable t) throws Exception {
