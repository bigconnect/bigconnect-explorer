...
public class DashboardDelete implements ParameterizedHandler {
    ...
    @Inject
    public DashboardDelete(WebWorkspaceRepository webWorkspaceRepository) {
    ...
    public ClientApiSuccess handle(
        ...
        Dashboard dashboard = webWorkspaceRepository.findDashboardById(workspaceId, dashboardId, user);
        if (dashboard == null) {
            throw new BcResourceNotFoundException("Could not find dashboard with id " + dashboardId);
        }

        webWorkspaceRepository.deleteDashboard(workspaceId, dashboardId, user);
