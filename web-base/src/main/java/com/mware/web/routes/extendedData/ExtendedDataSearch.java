...
import com.mware.core.model.search.ExtendedDataSearchRunner;
...
public class ExtendedDataSearch extends GeObjectSearchBase implements ParameterizedHandler {
    @Inject
    public ExtendedDataSearch(Graph graph,
                              SearchRepository searchRepository,
                              SchemaRepository schemaRepository,
                              AuditService auditService) {
        super(graph, (GeObjectSearchRunnerBase) searchRepository.findSearchRunnerByUri(ExtendedDataSearchRunner.URI),
