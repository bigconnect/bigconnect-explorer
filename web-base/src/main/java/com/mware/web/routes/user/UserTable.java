...
public class UserTable implements ParameterizedHandler {
    ...
    @Inject
    public UserTable(final UserRepository userRepository) {
    ...
    public ClientApiUsers handle(
        ...
        List<User> users = toList(userRepository.find(0, 10000));
        return userRepository.toClientApi(users, new HashMap<>());
    }
}
