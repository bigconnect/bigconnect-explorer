...
public class VertexDeleteProperty implements ParameterizedHandler {
    ...
    public ClientApiSuccess handle(
        ...
        if (isComment && request.getPathInfo().equals("/vertex/property")) {
            throw new BcException("Use /vertex/comment to save comment properties");
        } else if (request.getPathInfo().equals("/vertex/comment") && !isComment) {
            throw new BcException("Use /vertex/property to save non-comment properties");
        }
        ...
        workspaceHelper.deleteProperties(vertex, propertyKey, propertyName, schemaProperty, workspaceId,
                authorizations, user);
