...
public class OntologyManagerPropertyAddExisting implements ParameterizedHandler {
    private final SchemaRepository schemaRepository;
    private final WebQueueRepository webQueueRepository;

    @Inject
    public OntologyManagerPropertyAddExisting(
    ...
    public ClientApiSuccess handle(
        ...
        SchemaProperty op = schemaRepository.getPropertyByName(property.getTitle(), namespace);
