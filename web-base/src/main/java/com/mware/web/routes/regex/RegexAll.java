...
public class RegexAll implements ParameterizedHandler {
    ...
    @Inject
    public RegexAll(final RegexEntryRepository regexEntryRepository) {
        this.regexEntryRepository = regexEntryRepository;
    }

    @Handle
    public List<RegexEntry> handle(User authUser) throws Exception {
        List<RegexEntry> entries = toList(regexEntryRepository.findAll(authUser));
        return entries;
    }
}
