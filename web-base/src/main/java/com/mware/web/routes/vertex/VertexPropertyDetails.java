...
import com.mware.web.model.ClientApiVertexPropertyDetails;
...
public class VertexPropertyDetails implements ParameterizedHandler {
    private static final BcLogger LOGGER = BcLoggerFactory.getLogger(VertexPropertyDetails.class);
    ...
    public ClientApiVertexPropertyDetails handle(
        ...
        if (vertex == null) {
            throw new BcResourceNotFoundException("Could not find vertex with id: " + vertexId, vertexId);
        }
        ...
        if (property == null) {
            ...
            if (property == null) {
                throw new BcResourceNotFoundException("Could not find property " + propertyKey + ":" + propertyName + ":" + visibility + " on vertex with id: " + vertexId, vertexId);
            }
        }
