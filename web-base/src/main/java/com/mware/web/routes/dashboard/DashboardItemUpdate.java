...
import com.mware.web.model.ClientApiDashboardItemUpdateResponse;
...
public class DashboardItemUpdate implements ParameterizedHandler {
    ...
    @Inject
    public DashboardItemUpdate(WebWorkspaceRepository webWorkspaceRepository) {
    ...
    public ClientApiDashboardItemUpdateResponse handle(
        ...
        dashboardItemId = webWorkspaceRepository.addOrUpdateDashboardItem(workspaceId, dashboardId, dashboardItemId, title, configuration, extensionId, user);
