...
public class ProductUpdate implements ParameterizedHandler {
    ...
    public ProductUpdate(
            final WebWorkspaceRepository webWorkspaceRepository,
    ...
    public ClientApiProduct handle(
        ...
        if (previewDataUrl == null) {
            ...
            product = webWorkspaceRepository.addOrUpdateProduct(workspaceId, productId, title, kind, params, user);
        } else {
            product = webWorkspaceRepository.updateProductPreview(workspaceId, productId, previewDataUrl, user);
        }
