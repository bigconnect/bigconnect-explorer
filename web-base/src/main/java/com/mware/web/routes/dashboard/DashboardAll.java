...
public class DashboardAll implements ParameterizedHandler {
    ...
    public ClientApiDashboards handle(
        ...
        Collection<Dashboard> dashboards = webWorkspaceRepository.findAllDashboardsForWorkspace(workspaceId, user);
        if (dashboards == null) {
            throw new BcResourceNotFoundException("Could not find dashboards for workspace " + workspaceId);
        }
