...
import com.mware.web.model.ClientApiVertexCountsByConceptType;
...
public class VertexGetCountsByConceptType implements ParameterizedHandler {
    ...
    public ClientApiVertexCountsByConceptType handle(
        ...
        Map<Object, Long> conceptTypeCounts = graph.getVertexPropertyCountByValue(SearchIndex.CONCEPT_TYPE_FIELD_NAME, authorizations);
