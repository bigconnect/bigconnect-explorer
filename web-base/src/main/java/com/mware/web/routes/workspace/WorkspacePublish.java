...
public class WorkspacePublish implements ParameterizedHandler {
    ...
    @Inject
    public WorkspacePublish(final WorkspacePublishHelper workspacePublishHelper) {
    ...
    public ClientApiWorkspacePublishResponse handle(
        ...
        ClientApiWorkspacePublishResponse workspacePublishResponse = workspacePublishHelper.publish(publishData, user, workspaceId, authorizations);
