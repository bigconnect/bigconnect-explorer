...
public class WorkspaceSchema extends Schema {
    @Inject
    public WorkspaceSchema(final SchemaRepository schemaRepository) {
        super(schemaRepository);
    }

    @Handle
    public ClientApiSchema handle(@Required(name = "workspaceId") String workspaceId, BcResponse response) throws Exception {
