...
@Singleton
public class RestoreElements implements ParameterizedHandler {
    private LongRunningProcessRepository longRunningProcessRepository;
    private SearchRepository searchRepository;

    @Inject
    public RestoreElements(LongRunningProcessRepository longRunningProcessRepository,
    ...
    public ClientApiLongRunningProcessSubmitResponse handle(
        ...
        DeleteRestoreElementsLRPQueueItem queueItem =
                new DeleteRestoreElementsLRPQueueItem(savedSearchId, false, search.name,
                        user.getUserId(), authorizations.getAuthorizations(),
                        DeleteRestoreElementsLRPQueueItem.SEARCH_RESTORE_ELEMENTS_TYPE);
