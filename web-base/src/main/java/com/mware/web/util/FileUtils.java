...
public class FileUtils {
    public static File getApplicationFile(String relativePath) {
        Path filePath = getApplicationFolder().toPath().resolve(relativePath);
        return filePath.toFile();
    }

    public static File getApplicationFolder() {
        return new File(System.getenv(ENV_BC_DIR));
    }

    public static Path getDatastorePath() {
        return Paths.get(System.getenv(ENV_BC_DIR)).resolve("datastore");
    }

    public static Path geLibPath() {
        return Paths.get(System.getenv(ENV_BC_DIR)).resolve("lib");
    }

    public static Path getRunPath() {
        return Paths.get(System.getenv(ENV_BC_DIR)).resolve("run");
    }
