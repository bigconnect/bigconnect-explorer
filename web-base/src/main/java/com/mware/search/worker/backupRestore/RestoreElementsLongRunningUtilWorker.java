...
import static com.mware.search.worker.backupRestore.DeleteRestoreElementsLRPQueueItem.SEARCH_RESTORE_ELEMENTS_TYPE;
import static com.mware.search.worker.backupRestore.DeleteRestoreUtil.getBackupFilePrefix;

@Name("Restore Elements")
@Description("Restore elements based on a saved search backup")
@Singleton
public class RestoreElementsLongRunningUtilWorker extends LongRunningProcessWorker {
    private static final BcLogger LOGGER = BcLoggerFactory.getLogger(RestoreElementsLongRunningUtilWorker.class);
    ...
    @Inject
    public RestoreElementsLongRunningUtilWorker(
