...
public class GeBehaviour implements Behaviour, Serializable {
    ...
    public GeBehaviour(Vertex vertex, List<BehaviourQuery> queryList) {
    ...
    public String getName() {
        return BehaviourSchema.BH_NAME.getPropertyValue(properties);
    }

    @Override
    public String getDescription() {
        return BehaviourSchema.BH_DESCRIPTION.getPropertyValue(properties);
    }

    @Override
    public int getThreshold() {
        return BehaviourSchema.BH_THRESHOLD.getPropertyValue(properties);
    }
