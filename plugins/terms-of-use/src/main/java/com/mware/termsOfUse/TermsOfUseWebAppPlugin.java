...
public class TermsOfUseWebAppPlugin implements WebAppPlugin {
    ...
    public void init(WebApp app, ServletContext servletContext, Handler authenticationHandler) {
        app.registerJavaScriptTemplate("/com/mware/termsOfUse/terms-of-use.hbs");
        app.registerJavaScript("/com/mware/termsOfUse/terms-of-use-plugin.js");
        app.registerResourceBundle("/com/mware/termsOfUse/messages.properties");
