    ...
    function CollapsedNodePopoverShim() {
        this.popoverInitialize = function() {
            this.attacher = attacher()
                ...
                .path('com/mware/web/product/graph/dist/CollapsedNodePopoverConfig')
        ...
        this.getTemplate = function() {
            return new Promise(
                f => require(['com/mware/web/product/graph/popovers/collapsedNode/collapsedNodePopoverTpl.hbs'], f)
            );
        };
    }
});
