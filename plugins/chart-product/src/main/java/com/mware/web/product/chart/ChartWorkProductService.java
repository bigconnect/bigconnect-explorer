...
public class ChartWorkProductService implements WorkProductService {
    public static final String KIND = "org.bigconnect.web.product.chart.ChartWorkProduct";
    ...
    public WorkProductExtendedData getExtendedData(Graph graph, Vertex workspaceVertex, Vertex productVertex, GetExtendedDataParams params, User user, Authorizations authorizations) {
        ...
        extendedData.setVertices(Collections.emptyMap());
        extendedData.setEdges(Collections.emptyMap());
        return extendedData;
    }
