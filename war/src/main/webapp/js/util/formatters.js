    ...
    var FORMATTERS = {
        ...
        boolean: {
            ...
            pretty: function(bool) {
                ...
                if (bool === 'T' || bool === '1') bool = true;
                if (bool === 'F' || bool === '0') bool = false;
        ...
        date: {
             ...
             */
            local: function(str) {
                if (_.isUndefined(str) || _.isNaN(str) || _.isNull(str)) return '';
            ...
            dateString: function(millisStr) {
                if (_.isUndefined(millisStr) || _.isNaN(millisStr) || _.isNull(millisStr)) return '';
            ...
            relativeToDate: function(date, fromDate) {
                if (_.isUndefined(date) || _.isNaN(date) || _.isNull(date)) return '';
        ...
        timezone: {
            ...
            lookupTimezone: function(name, withOffsetForDate) {
                ...
                var abbr = momentZone.abbr(withOffsetForDate);
                if(abbr === 'EET' || abbr === 'EEST') {
                    tz = {
                        dst: true,
            ...
            getPreferences: function () {
                if (bcData
                    && bcData.currentUser
                    && bcData.currentUser.uiPreferences
                    && 'org.bigconnect.timezone' in bcData.currentUser.uiPreferences) {
                    try {
                        return JSON.parse(bcData.currentUser.uiPreferences['org.bigconnect.timezone']);
                    } catch(e) {
