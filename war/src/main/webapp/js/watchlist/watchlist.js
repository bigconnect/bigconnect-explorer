...
define([
    ...
    return defineComponent(WatchList, withDataRequest, withFormHelpers);
                    ...
                    this.select('div > ol.inner-list')
                        ...
                        .call(function() {
                            ...
                            this.select('table')
                                .selectAll('tr')
                                .data(function(d) {
                                    return _.sortBy(_.pairs(_.omit(d, 'propertyName')), function(pair) {
                                        var list = 'elementTitle'.split(' '),
