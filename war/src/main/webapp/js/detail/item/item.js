...
define([
     ...
     *
     * @param {org.bigconnect.layout.component~applyTo|org.bigconnect.layout.component~applyToFn} [applyTo] When does this component get used
     ...
     * @param {object} [layout]
     * @param {string} [layout.type] Which {@link org.bigconnect.layout.type|layout type} to render `children`.
     ...
     * @param {org.bigconnect.layout.component~child} [collectionItem] Reference to layout component to render for each item in model (requires model to be array).
     * @param {array.<org.bigconnect.layout.component~child>} [children] Children items to render
     */
    registry.documentExtensionPoint('org.bigconnect.layout.component',
        ...
        'https://docs.bigconnect.io/developer-guide/plugin-development/web-plugins/extension-point-reference-1/inspector-component'
    );

    /**
     * BigConnect Explorer includes the [Flex](web/war/src/main/webapp/js/detail/item/types/flex.js) layout type.
     *
     ...
     */
    registry.documentExtensionPoint('org.bigconnect.layout.type',
    ...
    function zipChildrenWithModels(layoutComponent, model) {
         ...
         *
         * @typedef org.bigconnect.layout.component~child
    ...
    function initializeLayout(el, domElements, layoutComponent) {
        ...
        var type = _.findWhere(registry.extensionsForPoint('org.bigconnect.layout.type'), { type: layoutConfig.type });
            ...
            for (var i = 0; i < el.classList.length; i++) {
                ...
                if (index === -1) {
                    ...
                    if (existing !== 'type-content' ||
                        !_.contains(classes, 'org-bigconnect-layout-root')) {
    ...
    function findLayoutComponentsMatching(match) {
         ...
         *
         * @typedef org.bigconnect.layout.component~applyTo
        ...
        /**
         * @callback org.bigconnect.layout.component~applyToFn
         * @param {object} model
         * @param {object} match
        ...
        var components = registry.extensionsForPoint('org.bigconnect.layout.component'),
                        ...
                        if (_.isObject(useModel) && 'id' in useModel && useModel.properties) {
                            ...
                            if (isVertex) {
                                if (applyTo.conceptIri || applyTo.displayType) {
                                    var conceptIriProperty = _.findWhere(useModel.properties, { name: ONTOLOGY_CONSTANTS.PROP_CONCEPT_TYPE}),
                                        conceptIri = conceptIriProperty && conceptIriProperty.value || ONTOLOGY_CONSTANTS.THING_CONCEPT,
                                        concept;
    ...
    function triggerUpdateModelAndStopPropagation(el, model) {
        ...
        if (el.classList.contains('org-bigconnect-layout-root')) {
            return;
        }
        $(el)
