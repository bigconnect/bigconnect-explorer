        ...
        render() {
            ...
            return (
                <div className="form">
                    ...
                    <h1>{i18n('detail.text.terms.form.delete')}</h1>

                    <p>{i18n('detail.text.terms.form.delete.p')}</p>
                    <p><Element element={element} />, <em>{concept.displayName}</em> ?</p>
                    <p style={{fontStyle: 'italic', color: '#999', fontSize: '90%'}}>{i18n('detail.text.terms.form.delete.note')}</p>

                    <div className="buttons">
                        <button onClick={onCancel} className="btn btn-link btn-small">{i18n('detail.text.terms.form.cancel')}</button>
                        <button onClick={this.onDelete} className={classNames('btn btn-danger btn-small', { loading })}>{i18n('detail.text.terms.form.delete.button')}</button>
                    </div>
                </div>
            )
        },
