...
define([
    ...
    const TEXT_PROPERTIES = [
        ONTOLOGY_CONSTANTS.PROP_VIDEO_TRANSCRIPT,
        ONTOLOGY_CONSTANTS.PROP_TEXT
    ];
    const PREVIEW_SELECTORS = {
        audio: 'div .audio-preview',
        video: '.org-bigconnect-video'
    };
     ...
     * @param {org.bigconnect.detail.text~shouldReplaceTextSectionForVertex} shouldReplaceTextSectionForVertex Whether the component should be rendered instead of the default
     */
    registry.documentExtensionPoint('org.bigconnect.detail.text',
        ...
        'https://docs.bigconnect.io/developer-guide/plugin-development/web-plugins/extension-point-reference-1/inspector-text'
    )
    ...
    function Text() {
        ...
        this.attributes({
            ...
            detailSectionContainerSelector: '.org-bigconnect-layout-body',
            model: null
        });
        ...
        this.onEditProperty = function(evt, data) {
            ...
            if (property.name === ONTOLOGY_CONSTANTS.PROP_TEXT) {
                Promise.all([
                    Promise.require('detail/dropdowns/textForm/textForm'),
                    // Wait for expansion
                    section.hasClass('expanded') ? Promise.resolve() : self.onToggleCollapsibleSection(evt)
                ]).spread(function (TextForm) {
                    if (text.length) {
                        root.prependTo(text);
                    }

                    TextForm.teardownAll();
                    TextForm.attachTo(root, {
                        data: self.model,
                        property: property
                    });
                });
                        ...
                        .call(function() {
                            this.enter()
                                ...
                                .call(function() {
                                    ...
                                    this.append('div').attr('class', 'text bc-allow-dblclick-selection');
                                });
        ...
        this.openText = function(propertyKey, propertyName, options) {
            ...
            var extensions = _.filter(registry.extensionsForPoint('org.bigconnect.detail.text'), function(e) {
                    /**
                     * @callback org.bigconnect.detail.text~shouldReplaceTextSectionForVertex
            ...
            if (extensions.length) {
                textPromise = Promise.require('util/component/attacher')
                    .then(function(Attacher) {
                        /**
                         * @typedef org.bigconnect.detail.text~Component
        ...
        this.scrollToMediaPreview = function($detailBody) {
            ...
            var $scrollParent = bcData.isFullscreen ? $('html, body') : $detailBody,
                scrollTop = bcData.isFullscreen ? this.$mediaNode.offset().top : this.$mediaNode.position().top;
