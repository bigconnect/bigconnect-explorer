    ...
    function ImageView() {
        ...
        this.updateImageBackgroundSize = function() {
            if (this.imageNaturalSize &&
                ...
                this.$node.css('background-position-x', 'right');
            }
        };
        ...
        this.isArtifactDisplayType = function() {
            ...
            if (concept && concept.displayType) {
                return (/^(video)$/).test(concept.displayType);
            }
            return false;
        }
        ...
        this.onUpdateModel = function(event, data) {
           var hasCustomImage = _.contains(data.model.edgeLabels, ONTOLOGY_CONSTANTS.EDGE_LABEL_HAS_IMAGE);
