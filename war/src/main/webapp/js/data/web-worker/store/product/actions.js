...
define(['../actions'], function(actions) {
    ...
    return actions.createActions({
        ...
        actions: {
            ...
            get: (productId, invalidate = false) => ({ productId, invalidate }),
            updateNeedsLayout: (productId, needsLayout) => ({ productId, needsLayout }),
            create: (title, kind, params) => ({ title, kind, params }),
            select: (productId) => ({ productId }),
            delete: (productId) => ({ productId }),
            updateTitle: (productId, title) => ({ productId, title }),
            updateExporting: (productId, exporting) => ({ productId, exporting }),
