...
define([
    ...
    'create-react-class',
    'util/formatters',
], function(React, redux, createReactClass, F) {

    const FilePreview = createReactClass({
        getInitialState() {
            return { rows: null, total: null, error: false }
        },

        componentWillReceiveProps(nextProps) {
            if (nextProps.analysis) {
                this.setState({...nextProps.analysis});
            }
        },
        ...
        onClick() {
            require([
                ...
                CSVMappingForm.attachTo($modal, { tmpFile : this.props.analysis.tmpFile });
            });
        },
