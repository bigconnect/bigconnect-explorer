...
define([
    ...
    const FileImportWizad = createReactClass({
        cancelWizard() {
            this.props.onSetLoadType('');
        },
    ...
    const ConnectedComponent = bcApi.connectReact()(FileImportWizad);
    ...
    return redux.connect(
        ...
        (dispatch, props) => {
            return {
                fileUploaded: (file) => { dispatch(ingestActions.fileUploaded(file)) }
            }
        }
    )(ConnectedComponent)
});
