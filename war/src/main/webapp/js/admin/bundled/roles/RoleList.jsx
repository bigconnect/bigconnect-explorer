...
define([
    ...
    const RoleList = createReactClass({
        ...
        loadData() {
            ...
            this.dataRequest('role', 'table', {pageSisze: tableState.pageSize, page: tableState.page, sorted: tableState.sorted, filtered: tableState.filtered})
                .then((roles) => {
                    this.setState({
                        data: roles,
                        pages: 1,
        ...
        handleDelete(event, row) {
            ...
            ConfirmDialog.showDialog('Are you sure?')
                .then(function() {
                    self.dataRequest('role', 'delete', row.value)
                        .then(function() {
            ...
            return (
                <div className="panel">
                    <div className="panel-heading">
                        <div className="panel-heading-title">Roles</div>
                        <div className="panel-heading-subtitle text-muted">
                            Roles define what data users can access and what privileges they have
                        </div>
