...
define([
    ...
    return defineComponent(QuickSearch, withDataRequest);

    function QuickSearch() {
        this.defaultAttrs({
            resultsContainerSelector: '.qs-results'
        });

        this.after('initialize', function () {
            if (!this.attr.searchQuery) {
                throw 'searchQuery attribute required';
            }
