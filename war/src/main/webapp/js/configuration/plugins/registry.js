...
/**
 * View all available extensions and registrations in the _Admin_ panel inside BC under _UI Extensions_.
 * Documentation with examples is available at {@link https://docs.bigconnect.io/developer-guide/plugin-development/web-plugins/extension-point-reference-1}.
 *
 * @module registry
...
The extension will continue to work, but the old name will be removed in future releases`)
            ...
            /**
             * Register new functionality at the given `extensionPoint`. View the {@link http://docs.bigconnect.io/extension-points/front-end docs} for available extension points, or in BigConnect Explorer, open the Admin panel, then UI Extensions.
             *
             ...
             * @example
             * registry.registerExtension('org.bigconnect.menubar', {
             *     title: 'New'
             *     identifier: 'org-bigconnect-example-new',
             *     action: {
             *         type: 'full',
