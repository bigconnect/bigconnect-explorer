...
define([
    ...
    var AUTO_UPDATE_INTERVAL_SECONDS = 60, // For updating relative times
        ACTIVITY_EXTENSTION_POINT = 'org.bigconnect.activity',
        handlersByKind = {},
        handlersByType = {};
    ...
    function processAllowCancel(process) {
        var handler = handlersByType[process.type];
        return !handler || handler.allowCancel === true;
    }
    ...
    function Activity() {
        ...
        this.after('initialize', function() {
             ...
             * @param {org.bigconnect.activity~titleRenderer} titleRenderer Render the title for row
             * @param {Array.<string>} [eventNames] Required if `eventWatcher`. Start event name, end event name.
             * @param {string} [finishedComponentPath] Path to {@link org.bigconnect.activity~FinishedComponent} to render when task is complete.
             * @param {org.bigconnect.activity~onRemove} [onRemove] Invoked when row is removed
             ...
             */
            registry.documentExtensionPoint('org.bigconnect.activity',
                ...
                'https://docs.bigconnect.io/developer-guide/plugin-development/web-plugins/extension-point-reference-1/activity'
            );
            ...
            this.tasks = bcData.currentUser && bcData.currentUser.longRunningProcesses || [];
        ...
        this.removeTask = function(taskId) {
            ...
            if (handler && handler.onRemove) {
                if (_.isFunction(handler.onRemove)) {
                     ...
                     *
                     * @callback org.bigconnect.activity~onRemove
                     * @example
                     * onRemove() {
                        ...
                        .call(function() {
                                ...
                                .call(function() {
                                    ...
                                    this.append('div')
                                        ...
                                        .call(function() {
                                            ...
                                            this.append('button')
                                                .attr('class', 'btn btn-xs btn-raised btn-danger delete')
                            ...
                            this.select('.actions-plugin').each(function() {
                                ...
                                if (handler) {
                                    ...
                                    if (Component && datum.endTime) {
                                         ...
                                         *
                                         * @typedef org.bigconnect.activity~FinishedComponent
                            ...
                            this.select('.type-container').each(function() {
                                ...
                                if (datum.type && datum.type in handlersByType) {
                                     ...
                                     *
                                     * @callback org.bigconnect.activity~titleRenderer
