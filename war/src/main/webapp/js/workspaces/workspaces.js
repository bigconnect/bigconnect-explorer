...
define([
    ...
    function Workspaces() {
        ...
        this.defaultAttrs({
            listSelector: 'ul.workspaces-list',
            workspaceListItemSelector: 'ul.workspaces-list li',
        ...
        this.switchToWorkspace = function(workspaceId) {
            if (workspaceId !== bcData.currentWorkspaceId) {
        ...
        this.onDisclosure = function(event) {
            ...
            var container = this.select('formSelector'),
                form = container.show().find('.content'),
        ...
        this.onWorkspaceUpdated = function(event, data) {
            ...
            this.update(
                ...
                .tap(function(workspaces) {
                    if (_.findWhere(updatedWorkspace.users, { userId: bcData.currentUser.id })) {
                    ...
                    return function() {
                        ...
                        entering
                            ...
                            .call(function() {
                                ...
                                this.append('button').attr('class', 'disclosure')
                                    .append('i').attr('class','material-icons').text('settings');
                                this.append('div').attr('class', 'item-title')
                                this.append('div').attr('class', 'item-subtitle')
                            });
                        ...
                        this.classed('active', function(w) {
                            return w.workspaceId === bcData.currentWorkspaceId;
                        });
                        ...
                        this.select('.item-subtitle').text(function(w) {
                            var people = _.reject(w.users, function(user) {
                                    return user.userId === bcData.currentUser.id;
                                }).length,
                                subtitle = '',
                ...
                if (data.visible) {
                    _.defer(function() {
                        self.loadWorkspaceList()
                            .then(function(workspaces) {
                                var active = bcData.currentWorkspaceId;
