...
define([
    ...
    var COMMENT_ENTRY_IRI = ONTOLOGY_CONSTANTS.PROP_COMMENT_ENTRY;
    var DiffPanel;
    ...
    function Diff() {
        ...
        this.render = function() {
            ...
            if(!this.publishing && !this.undoing)
                this.$node.unblock();
                        ...
                        if (isElementVertex) {
                            ...
                            if (outputItem.vertex) {
                                ...
                                outputItem.vertex = {
                                    id: elementId,
                                    properties: [],
                                    [ONTOLOGY_CONSTANTS.PROP_VISIBILITY_JSON]: diffs[0][ONTOLOGY_CONSTANTS.PROP_VISIBILITY_JSON]
                                };
                            ...
                            if (outputItem.edge) {
                                ...
                                outputItem.edge = {
                                    id: elementId,
                                    properties: [],
                                    [ONTOLOGY_CONSTANTS.PROP_VISIBILITY_JSON]: diffs[0].visibilityJson
                                };
                            }
        ...
        this.onSelectAll = function(action) {
            const canPublishOntology = Boolean(bcData.currentUser.privilegesHelper.ONTOLOGY_PUBLISH);
        ...
        this.onApplyAll = function(type, publishOntology) {
            ...
            this.$node.block({message: 'Publishing...'});
        ...
        this.buildOntologyToPublish = function() {
            const currentUserId = bcData.currentUser.id;
            const concepts = {};
            const relationships = {};
            const properties = {};
            const ontologyObjectCreatedByCurrentUser = ontology => {
                if (ontology.metadata) {
                    const modifiedBy = ontology.metadata[ONTOLOGY_CONSTANTS.PROP_MODIFIED_BY];
        ...
        this.onMarkUndo = function(diffId, state) {
            var self = this,
                ...
                canPublishOntology = Boolean(bcData.currentUser.privilegesHelper.ONTOLOGY_PUBLISH),
                vertexDiff;
