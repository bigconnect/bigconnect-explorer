...
define([
    ...
    './TimeZoneDropDown'
], function (React, createReactClass, jstz, F, withDataRequest, TimeZoneDropDown) {
    'use strict';
    ...
    const TimeZoneSetting = createReactClass({
        ...
        savePreferences(preferences) {
            withDataRequest.dataRequest('user', 'preference', 'org.bigconnect.timezone', JSON.stringify(preferences))
                .then(() => {
                    bcData.currentUser.uiPreferences['org.bigconnect.timezone'] = JSON.stringify(preferences);
                ...
                <div style={{display: 'block'}}>
                    ...
                    <label style={{display: 'inline'}}>
                        <input type="checkbox"
                               ...
                               onChange={this.handleDetectChange}/> {i18n('useraccount.page.setting.timezone.field.detect')}
                    </label>
                </div>
            </div>);
        }
