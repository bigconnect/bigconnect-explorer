    ...
    function Welcome() {
        ...
        var builtIn = {
            ...
            icons = {
                ...
                dashboard: 'img/glyphicons/white/glyphicons_331_dashboard@2x.png',
                logout: 'img/glyphicons/white/glyphicons_387_log_out@2x.png',
                products: 'img/glyphicons/white/glyphicons_326_share@2x.png',
        ...
        this.after('initialize', function() {
            this.$node
                .css('overflow', 'auto')
                .addClass('org-bigconnect-welcome')
                .html(template({}));
        ...
        function getDisplayAndTemplatePathForIdentifier(identifier) {
            ...
            console.debug('No welcome template for identifier', identifier)
        }
    }
});
