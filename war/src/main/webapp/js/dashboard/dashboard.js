...
define([
    ...
    /**
     * @typedef org.bigconnect.dashboard.item~filter
     ...
     *
     * @typedef org.bigconnect.dashboard.item~aggregation
     ...
     *
     * @typedef org.bigconnect.dashboard.item~reportParametersForSearch
     ...
     * @property {string} filter JSON array of {@link org.bigconnect.dashboard.item~filter} objects to `AND`.
     * @property {Array.<string>} [aggregations] List of {@link org.bigconnect.dashboard.item~aggregation} to apply, each item is json string.
     ...
     * They can be included in defaults dashboards using the {@link org.bigconnect.web.dashboard.layout}
     * extension, or added manually by users using the "Add Item" button
     * when editing dashboards.
     *
     * The bundled items are defined in [registerDefaultItems.js](web/war/src/main/webapp/js/dashboard/registerDefaultItems.js) for examples.
     *
     ...
     * to a {@link org.bigconnect.web.dashboard.reportRenderer} that can handle that data. The most common
     ...
     * @param {object} [report] Use BigConnect reportRenderers to render a search aggregation
     * @param {string} [report.defaultRenderer] The identifier of a report renderer to use as default when adding this item.
     * @param {string} report.endpoint The endpoint path to access the data. See [`Router`](web/web-base/src/main/java/com/mware/web/Router.java) for all available endpoints.
     * @param {object} [report.endpointParameters] Parameters to pass to endpoint.
     * Parameters when using search: {@link org.bigconnect.web.dashboard.item~reportParametersForSearch}
     ...
     * @param {string} [componentPath] The path to the {@link org.bigconnect.web.dashboard.item~Component|Component}
     * to render when the user selects this item from the list.
     * @param {string} [configurationPath] The path to the {@link org.bigconnect.web.dashboard.item~ConfigComponent|ConfigComponent}.
     ...
     * });
     */
    registry.documentExtensionPoint('org.bigconnect.web.dashboard.item',
        ...
        'https://docs.bigconnect.io/developer-guide/plugin-development/web-plugins/extension-point-reference-1/dashboard-item'
    );
     ...
     * [`reportRenderers.js`](web/war/src/main/webapp/js/dashboard/reportRenderers.js).
     *
     ...
     * @param {string} componentPath RequireJS path to {@link org.bigconnect.web.dashboard.item~Component} component.
     ...
     * })
     */
    registry.documentExtensionPoint('org.bigconnect.web.dashboard.reportrenderer',
        ...
        'https://docs.bigconnect.io/developer-guide/plugin-development/web-plugins/extension-point-reference-1/dashboard-report-renderer'
    );

    /**
     * When a new space is created or new user logs in, this will define
     ...
     * The default layout is defined in [`defaultLayout.js`](web/war/src/main/webapp/js/dashboard/defaultLayout.js).
     *
     * @param {Array} config Array of dashboard item configurations
     * @example
     * registry.registerExtension('org.bigconnect.web.dashboard.layout', [
     *     {
     ...
     * ])
     */
    registry.documentExtensionPoint('org.bigconnect.web.dashboard.layout',
        'Define dashboard layout for new workspaces',
        function(e) {
            return _.isArray(e);
        },
        'https://docs.bigconnect.io/developer-guide/plugin-development/web-plugins/extension-point-reference-1/dashboard-layout'
    );
     ...
     * @param {string} [action.componentPath] Required when `type=popover`. Path to {@link org.bigconnect.web.dashboard.toolbar.item~Component|Component} to render in popover
     ...
     * @param {org.bigconnect.web.dashboard.toolbar.item~canHandle} [canHandle] Function to decide if this item should be added to this card
     */
    registry.documentExtensionPoint('org.bigconnect.dashboard.toolbar.item',
        ...
        'https://docs.bigconnect.io/developer-guide/plugin-development/web-plugins/extension-point-reference-1/dashboard-toolbar-item'
    );
    ...
    function Dashboard() {
        ...
        this.after('initialize', function() {
            ...
            reportRenderers = registry.extensionsForPoint('org.bigconnect.web.dashboard.reportrenderer');
            extensions = registry.extensionsForPoint('org.bigconnect.web.dashboard.item');
            layouts = registry.extensionsForPoint('org.bigconnect.web.dashboard.layout');
            toolbarExtensions = registry.extensionsForPoint('org.bigconnect.dashboard.toolbar.item');
            ...
            this.on('configurationChanged', {
                configureItemSelector: function(event, data) {
                    ...
                    self.onConfigurationChanged({ node: () => event.target }, data);
                }
            })
        ...
        this.onWindowResize = function(event) {
             ...
             *
             * @event org.bigconnect.web.dashboard.item#reflow
             */
            this.$node.find('.item-content').trigger('reflow')
        };
        ...
        this.onDashboardRefreshData = function(event, data) {
            ...
            items.forEach(function(item) {
                var $gridItem = self.$node.find('.grid-stack-item').filter(function() {
                    const myId = $(this).data('item-id');
                    return `${myId}` === `${item.id}`;
                });
                /**
                 * The dashboard includes a refresh button in the top left.
                 * When activated, needs to notify cards to update content if necessary.
                 *
                 * @event org.bigconnect.web.dashboard.item#refreshData
                 */
        ...
        this.onWorkspaceLoaded = function(event, workspace) {
            ...
            this.isCreator = workspace.createdBy === bcData.currentUser.id;
        ...
        this.onConfigureItem = function(attacher) {
            ...
            require(['./configure'], function(_ConfigPopover) {
                ...
                var itemId = $gridItem.data('item-id'),
                    item = _.findWhere(self.dashboard.items, { id: itemId.toString() });
        ...
        this.onRemoveItem = function(event) {
            ...
            if (itemId) {
                this.request('dashboardItemDelete', itemId)
                    .done(function() {
                        self.dashboard.items = _.filter(self.dashboard.items, it => it.id !== itemId);
                        ignoreGridStackChange = true;
        ...
        this.createDashboardItemComponent = function(node, item) {
            ...
            if (path) {
                return Promise.require(path).then(function(Component) {
                     ...
                     *
                     * @typedef org.bigconnect.web.dashboard.item~Component
                     ...
                     * @property {org.bigconnect.web.dashboard.item~configurationChanged} configurationChanged Change the configuration
                     * @listens org.bigconnect.web.dashboard.item#reflow
                     * @listens org.bigconnect.web.dashboard.item#refreshData
                    ...
                    Attacher().node($content)
                        ...
                        .behavior({
                            ...
                            /**
                             * @callback org.bigconnect.web.dashboard.item~configurationChanged
                             * @param {object} data
        ...
        this.updateToolbarExtensions = function(el, item, extension) {
            var validExtensions = _.reject(toolbarExtensions, function(e) {
                    ...
                    /**
                     * @callback org.bigconnect.web.dashboard.toolbar.item~canHandle
                     * @param {object} options
        ...
        this.loadDashboards = function(workspace) {
            ...
            return this.request('dashboards')
                .then(function(dashboards) {
                    ...
                    if (layouts.length) {
                        if (layouts.length > 1) {
                            console.warn(layouts.length + ' org.bigconnect.web.dashboard.layout extensions were found.'
        ...
        this.adjustHeader = function() {
            var $input = this.$node.find('h1.header input'),
                $span = $('<span>')
                    .text($input.val())
                    .css('white-space', 'pre')
                    .insertAfter(this.$node.find('.dashboard-toolbar')),
