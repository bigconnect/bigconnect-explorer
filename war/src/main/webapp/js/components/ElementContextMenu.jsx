...
define([
    ...
    const ElementContextMenuItem = createReactClass({
        ...
        componentWillMount() {
            ...
            const currentSelection = bcData.selectedObjects.vertexIds;
            ...
            this.getElement()
                .then((elements) => {
                    ...
                    const currentSelection = isVertex
                        ? bcData.selectedObjects.vertexIds
                        : bcData.selectedObjects.edgeIds;

                    registry.extensionsForPoint(`org.bigconnect.${isCollapsedItem ? 'collapsedItem' : isVertex ? 'vertex' : 'edge'}.menu`)
                        .filter(item => {
                            if (item.selection) {
            ...
            const items = [
                {
                    ...
                    canHandle: () => bcData.currentWorkspaceEditable
                },
                {
            ...
            return [
                ...
                DIVIDER,
                {
                    ...
                    shouldDisable: function(selection, vertexId, target) {
                        return !bcData.currentWorkspaceEditable || false;
