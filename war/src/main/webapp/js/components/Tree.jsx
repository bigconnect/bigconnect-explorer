 ...
 */
define([
    'create-react-class', 'prop-types', 'util/deepEquals', 'jstree'
], function(createReactClass, PropTypes, deepEquals) {
    'use strict';
    ...
    const Tree = createReactClass({
        ...
        shouldComponentUpdate(nextProps) {
            return !deepEquals(nextProps.treeData, this.props.treeData);
        },
