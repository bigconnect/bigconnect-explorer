...
function(withDataRequest) {
    ...
    var analyze = _.memoize(function(vertexId, tmpFile) {
        return withDataRequest.dataRequest('structuredIngest', 'analyze', vertexId, tmpFile)
    })

    return {
        CONCEPT_TYPE: ONTOLOGY_CONSTANTS.PROP_CONCEPT_TYPE,
        ...
        analyze: function(vertexId, options) {
            return analyze(vertexId, options.tmpFile)
