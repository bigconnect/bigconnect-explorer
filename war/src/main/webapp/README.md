...
Enable/Disable Ge graph performance tracing

		enableGraphTracing(true/false);
...
Darken pane backgrounds for poor displays/projectors. (persisted)

	enableHighContrast(true/false)
...
BigConnect Explorer's style for JavaScript and React. Inspired by / forked from the [Airbnb Style Guide](https://github.com/airbnb/javascript).
